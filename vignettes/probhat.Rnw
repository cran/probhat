...
\newcommand{\cat}{CAT}
\newcommand{\el}{EL}
\newcommand{\phgmix}{gMIX}
\newcommand{\phxmix}{xMIX}
...
\stitle {probhat}{0.4.1}{Multivariate Generalized\\Kernel Smoothing\\and\\Related Statistical Methods}
...
\itemsep -0.15cm
	...
	\item IT'S LIKELY THAT THESE MAY CHANGE TO S4-BASED FUNCTION OBJECTS, IN THE NEAR FUTURE.\\
	...
	\item Variable names are taken from column names (most cases) or list names (categorical distributions).
...
\itemsep -0.15cm
	...
	\item Parameter estimates, mixed conditional models (with mixed input), distribution sets and random number generation need improvement.
\end{itemize}
...
\begin{itemize}
	\item \textbf {Categorical Set}\\One probability distribution for each (categorical) level, out of many (categorical) levels.
	\item \textbf {Marginal Set}\\One univariate probability distribution for each variable, out of many variables.
	\item \textbf {Conditional Set}\\One probability distribution for each set of conditions.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
We can compute quantile-based statistics, using the \tmu{ph.median}, \tmu{ph.quantile} and \tmu{iqr} functions.
...
\ind \tmu {kubik: Cubic Hermite Splines and Related Root Finding Methods}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section* {Appendix C:\\Discrete Kernel Smoothing Formulae, and Related Notes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section* {Appendix D:\\Continuous Kernel Smoothing Formulae, and Related Notes}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
